...
public class CheckpointManager : MonoBehaviour {
    ...
    public void CheckPointReached(Checkpoint checkpoint) {
        ...
        if (CurrentCheckpointIndex >= Checkpoints.Count) {kartAgent.AddReward(0.5f); kartAgent.EndEpisode();}
        else {kartAgent.AddReward((0.5f) / Checkpoints.Count); SetNextCheckpoint();}
    }
